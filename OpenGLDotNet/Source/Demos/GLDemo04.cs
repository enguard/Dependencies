...
namespace OpenGLDemos
{
    ...
    public static class OpenGLDemo04
    {
        ...
        public static void SetupGL()
        {
            ...
            GL.TexImage2D(GL.GL_TEXTURE_2D, 0, 4, 320, 240, 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE, IL.GetData());
        ...
        public static void Display()
        {
            ...
            GL.Begin(GL.GL_QUADS);
            {
                ...
                GL.TexCoord2f(1.0f, 0.0f); GL.Vertex2f(2.0f, 0.0f);
                GL.TexCoord2f(1.0f, 1.0f); GL.Vertex2f(2.0f, 2.0f);
                GL.TexCoord2f(0.0f, 1.0f); GL.Vertex2f(0.0f, 2.0f);
            }
            GL.End();
        ...
        public static void Main(string[] args)
        {
            ...
            GLConfig.Init(2, 1, "Demo #04 - Texturing", 25, 25, 1024, 768);
            GL.Init(true);
            ...
            if (!IL.Load(IL.IL_TGA, @"c:\development\projects\quake2dotnet1\bin\debug\data\pics\conback22222.tga"))
            {
