...
namespace OpenGLDotNet
{
    public static class GLConfig
    {
        ...
        {   
            ...
            {"GL_AMDX_debug_output", true},                         // ATI/AMD GPUs report to support this; only renamed to GL_AMD_debug_output
        ...
        public unsafe static void Init(byte ReqGLVersionMajor, byte ReqGLVersionMinor, string WindowName, int WindowPosX, int WindowPosY, int WindowSizeX, int WindowSizeY)
        {
            ...
            if (glLib != 0)
            {
                ...
                FG.Init(new int[] { 0 }, null);
                FG.InitDisplayMode(GLUT.GLUT_RGBA | GLUT.GLUT_DOUBLE | GLUT.GLUT_DEPTH | GLUT.GLUT_ALPHA);
                FG.InitWindowPosition(WindowPosX, WindowPosY);
                FG.InitWindowSize(WindowSizeX, WindowSizeY);
                int hWindow = FG.CreateWindow(WindowName);
        ...
        public static void LogDumpToConsole()
        {
        ...
        public static void LogDumpToTextFile(string LogFileName)
        {
